...
//Step 4 - Add a dynamic year to the footerr.
//Hint: Google to find out how to get the current year using JS.

var currentTime = new Date();
var year = currentTime.getFullYear();

app.locals.myVar = year;
...
var random1 = adj[Math.floor(Math.random()*adj.length)];
var random2 = noun[Math.floor(Math.random()*noun.length)]; 

const randomName = (random1 + " "+ random2)
